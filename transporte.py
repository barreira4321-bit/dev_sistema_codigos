class Veiculo:
    ...
    def __init__(self, marca, modelo, cor, ano):
        ...
        self.__cor = cor
        self.__ano = ano
        self.cores = ['Branco', 'Preto', 'Cinza', 'Vermelho']
    ...
    def detalhes(self):
        print(f'Esse carro é da marca: {self.__marca}, do modelo: {self.__modelo}, da cor {self.__cor} e do ano: {self.__ano}')
...
class Carro(Veiculo):
    ...
    def acelerar(self):
        print(f'Andando {self.getMarca()} por aí')
